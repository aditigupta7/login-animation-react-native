...
import { View, Text, StyleSheet, ActivityIndicator, TextInput, TouchableOpacity, StatusBar, SafeAreaView, Image, Dimensions } from 'react-native';
...
export default function LoginScreen() {
    ...
    const handleSubmit = () => {
        ...
        if (!validatePassword(password)) {
            Toast.show('Enter one captial letter, one small, one digit and one special character', Toast.LONG);
            return;
        }
    ...
    return (
        <SafeAreaView style={{ backgroundColor: COLORS.white, flex: 1, paddingTop: WD(5), paddingHorizontal: WD(10) }}>
            <StatusBar
                animated={true}
            ...
            <View style={styles.container}>
                <View style={{ marginHorizontal: WD(10) }}>
                    <Animated.Image
                        style={[{ width: 80, height: 80, resizeMode: 'contain' }, animatedImageStyle]}
                ...
                <View style={styles.newUserText}>
                    <Text style={{ color: COLORS.dark, fontFamily: customFonts.bold }}>New User?</Text>
                    <TouchableOpacity>
                        <Text style={{ color: COLORS.primary, fontFamily: customFonts.bold }}> Sign Up</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
